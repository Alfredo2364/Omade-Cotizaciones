...
<body class="login-body">
    ...
    document.getElementById('registerForm').addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (result.success) {
                showToast(result.message, 'success'); // Assuming showToast exists globally or copied logic
                setTimeout(() => {
    ...
    // Inline toast logic if script.js fails or is missing specific toast logic
    function showToast(message, type = 'success') {
        ...
        if(!box || !overlay) { alert(message); return; }

        msg.textContent = message;
        icon.innerHTML = type === 'success' ? '<span style="color: #10b981; font-size: 2rem;">&#10004;</span>' : '<span style="color: #ef4444; font-size: 2rem;">&#10006;</span>';
        box.style.borderTop = type === 'success' ? '5px solid #10b981' : '5px solid #ef4444';
